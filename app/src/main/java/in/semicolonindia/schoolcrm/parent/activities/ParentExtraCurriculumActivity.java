...
import in.semicolonindia.schoolcrm.student.adapters.ExtracurriculamListAdapter;
import in.semicolonindia.schoolcrm.student.beans.ExtraCurriculamNames;
@SuppressWarnings("ALL")
public class ParentExtraCurriculumActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.parent_extra_activity_curriculum);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ParentExtraCurriculumActivity.this, ParentHomeActivity.class);
