...
public class TransportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.student_activity_transport);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(TransportActivity.this, StudentHomeActivity.class);
        ...
        for (int i = 0; i < bundle.getStringArray("transport_id").length; i++) {
            StudentTransportNames mStudentTransportNames = new StudentTransportNames(bundle.getStringArray("transport_id")[i],
            ...
            arraylist.add(mStudentTransportNames);
        }
