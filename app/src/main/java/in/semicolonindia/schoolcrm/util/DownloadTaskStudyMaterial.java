package in.semicolonindia.schoolcrm.util;
...
import static in.semicolonindia.schoolcrm.rest.BaseUrl.sStudyMaterialDownloadURL;
...
public class DownloadTaskStudyMaterial extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        //activity.startActivity(Intent.createChooser(intent, "SemiCRM/Downloads"));
