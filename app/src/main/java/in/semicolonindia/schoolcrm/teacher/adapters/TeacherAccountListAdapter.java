...
import static in.semicolonindia.schoolcrm.rest.BaseUrl.sUploadUserInfoURL;
import static in.semicolonindia.schoolcrm.rest.BaseUrl.tUploadUserInfoURL;
...
public class TeacherAccountListAdapter extends RecyclerView.Adapter<TeacherAccountListAdapter.ViewHolder> {
    ...
    private TeacherAccountBean mAccountBean;

    public TeacherAccountListAdapter(Activity activity, TeacherAccountBean mAccountBean) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case 0:
                rootView = LayoutInflater.from(parent.getContext()).inflate(R.layout.teacher_account_list_header, parent, false);
                mViewHolder = new ViewHolder(rootView, viewType);
                break;

            case 1:
                rootView = LayoutInflater.from(parent.getContext()).inflate(R.layout.teacher_account_list_body_items, parent, false);
                mViewHolder = new ViewHolder(rootView, viewType);
                break;

            case 2:
                rootView = LayoutInflater.from(parent.getContext()).inflate(R.layout.teacher_account_list_control_items, parent, false);
                mViewHolder = new ViewHolder(rootView, viewType);
                break;
        }
        return mViewHolder;
            ...
            case 2:
                ...
                holder.btnCancel.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        activity.startActivity(new Intent(activity, TeacherHomeActivity.class));
    ...
    private void uploadUserInfo() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, tUploadUserInfoURL,
    ...
    private void imagePopUp() {
        ...
        final View dialogView = inflater.inflate(R.layout.teacher_profile_pic_change_dialog, null);
