...
import in.semicolonindia.schoolcrm.teacher.adapters.TeacherNewsAdapter;
import in.semicolonindia.schoolcrm.teacher.beans.TeacherNewsName;
@SuppressWarnings("ALL")
public class TeacherNewsActivity extends AppCompatActivity {
    // 1. Declear All Variable....

    private ListView lv_News;
    private ListView lvStudyMat;
    TeacherNewsAdapter teacherNewsAdapter;
    ...
    private  String[] sDes;
    ArrayList<TeacherNewsName> arraylist = new ArrayList<TeacherNewsName>();


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.teacher_activity_news);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // onBackPressed();
                Intent intent = new Intent(TeacherNewsActivity.this, TeacherHomeActivity.class);
        ...
        for (int i = 0; i < sDate.length; i++){
            TeacherNewsName teacherNewsName = new TeacherNewsName(sTitle[i], sImages[i], sDate[i], sTime[i], sAdvertisement[i], sDes[i]);
            arraylist.add(teacherNewsName);
        }
        teacherNewsAdapter = new TeacherNewsAdapter(getApplicationContext(), arraylist);
        lv_News.setAdapter(teacherNewsAdapter);
