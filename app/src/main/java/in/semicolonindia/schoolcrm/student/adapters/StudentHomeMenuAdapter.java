...
public class StudentHomeMenuAdapter extends BaseAdapter {
    ...
    public StudentHomeMenuAdapter(Activity aActivity, String[] sTitles) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView = layoutInflater.inflate(R.layout.student_first_list_item, null);
