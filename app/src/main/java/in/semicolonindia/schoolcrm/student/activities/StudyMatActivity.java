...
import in.semicolonindia.schoolcrm.student.adapters.StudyMatListAdapter;
import in.semicolonindia.schoolcrm.student.beans.StudyMatNames;
...
public class StudyMatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.student_activity_study_mat);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(StudyMatActivity.this,StudentHomeActivity.class);
