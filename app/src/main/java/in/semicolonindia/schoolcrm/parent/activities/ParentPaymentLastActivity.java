...
import in.semicolonindia.schoolcrm.student.adapters.PaymentsListAdapter;
import in.semicolonindia.schoolcrm.student.beans.PaymentNames;

import static in.semicolonindia.schoolcrm.rest.BaseUrl.pGetPaymentURL;
@SuppressWarnings("ALL")
public class ParentPaymentLastActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.parent_activity_payment_detail);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ParentPaymentLastActivity.this, ParentPaymentFirstActivity.class);
    ...
    private void getPaymentDetails() {
        mProgressDialog = new ProgressDialog(ParentPaymentLastActivity.this, "Loading Payment...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        mProgressDialog.setCancelable(false);
        mProgressDialog.setCanceledOnTouchOutside(false);
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, pGetPaymentURL, new Response.Listener<String>() {
            @Override
                ...
                if (sResult != null) {
                    try {
                        ...
                        if (!jsonObject.getBoolean("error")) {
                            ...
                            Toast.makeText(ParentPaymentLastActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                        }
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(getApplicationContext(), ParentPaymentFirstActivity.class);
        startActivity(intent);
        finish();
    }
}
