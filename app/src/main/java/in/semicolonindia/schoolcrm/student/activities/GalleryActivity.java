...
import in.semicolonindia.schoolcrm.student.adapters.GalleryRVAdapter;
...
public class GalleryActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.student_activity_gallery);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // onBackPressed();
                /*Intent intent = new Intent(GalleryActivityDemo.this, StudentHomeActivity.class);
