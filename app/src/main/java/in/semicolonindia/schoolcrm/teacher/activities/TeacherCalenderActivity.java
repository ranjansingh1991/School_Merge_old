...
public class TeacherCalenderActivity extends AppCompatActivity implements OnDateSelectedListener, OnMonthChangedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.teacher_activity_calender);
        ...
        for (int i = 0; i < bundle.getStringArray("title").length; i++) {
            TeacherNotificationModel mNoticeNames = new TeacherNotificationModel(
