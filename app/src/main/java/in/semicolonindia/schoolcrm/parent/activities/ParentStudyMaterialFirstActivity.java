...
public class ParentStudyMaterialFirstActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.parent_activity_study_mat_first);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ParentStudyMaterialFirstActivity.this, ParentHomeActivity.class);
        ...
        lvStudentName.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(new ConnectionDetector(getApplicationContext()).isConnectingToInternet()) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), ParentStudyMaterialLastActivity.class);
                    ...
                    final NoConnectionDialog mNoConnectionDialog = new NoConnectionDialog(ParentStudyMaterialFirstActivity.this,
    ...
    private void getChildrenList() {
        mProgressDialog = new ProgressDialog(ParentStudyMaterialFirstActivity.this, "Loading Study Material...");
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, pLoginURL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if (response != null) {
                    ...
                    Toast.makeText(ParentStudyMaterialFirstActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                    mProgressDialog.dismiss();
                }
