...
import in.semicolonindia.schoolcrm.student.adapters.MessageListAdapter;
...
import static in.semicolonindia.schoolcrm.rest.BaseUrl.sGetTeacherMsg;
...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.student_activity_message);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(MessageActivity.this,StudentHomeActivity.class);
