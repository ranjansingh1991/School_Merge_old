...
import in.semicolonindia.schoolcrm.student.adapters.ChatListAdapter;
import in.semicolonindia.schoolcrm.student.beans.Chats;
import in.semicolonindia.schoolcrm.util.PreferencesManager;

import static in.semicolonindia.schoolcrm.rest.BaseUrl.pGetMsg;
import static in.semicolonindia.schoolcrm.rest.BaseUrl.pSendMsg;
@SuppressWarnings("ALL")
public class ParentChatActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatArrayAdapter = new ChatListAdapter(getApplicationContext(), R.layout.student_sender_chat_msg);
...
//                    String htmlEncodedString = Html.toHtml(etTxtMsg.getText());
    ...
    private void send(final String msg) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, pSendMsg, new Response.Listener<String>() {
            @Override
    ...
    private void receiveOld() {
        final ProgressDialog mProgressDialog = new ProgressDialog(ParentChatActivity.this, "Loading...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        mProgressDialog.setCancelable(false);
        mProgressDialog.setCanceledOnTouchOutside(false);
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, pGetMsg, new Response.Listener<String>() {
            @Override
            public void onResponse(String sResult) {
                if (sResult != null) {
                    try {
