...
import in.semicolonindia.schoolcrm.student.adapters.SubjectListAdapter;
import in.semicolonindia.schoolcrm.student.beans.SubjectNames;
...
public class SubjectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.student_activity_subject);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SubjectActivity.this,StudentHomeActivity.class);
