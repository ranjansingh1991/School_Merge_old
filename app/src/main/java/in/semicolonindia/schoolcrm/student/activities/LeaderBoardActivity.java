...
public class LeaderBoardActivity extends AppCompatActivity {
    ...
    /*TeacherLeaderBoardAdapter leaderBoardAdapter;
    ArrayList<LeaderBoardNames> arraylist = new ArrayList<LeaderBoardNames>();
*/
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.student_activity_leader_board);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(LeaderBoardActivity.this, StudentHomeActivity.class);
