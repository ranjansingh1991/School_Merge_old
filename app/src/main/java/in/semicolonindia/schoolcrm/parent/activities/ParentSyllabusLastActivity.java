...
import static in.semicolonindia.schoolcrm.rest.BaseUrl.pGetSyllabusURL;
@SuppressWarnings("ALL")
public class ParentSyllabusLastActivity extends AppCompatActivity {
    ListView lvSyllabus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.parent_activity_syllabus_last);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ParentSyllabusLastActivity.this, ParentSyllabusFirstActivity.class);
    ...
    private void getSyllabus() {
        mProgressDialog = new ProgressDialog(ParentSyllabusLastActivity.this, "Loading Syllabus...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        mProgressDialog.setCancelable(false);
        mProgressDialog.setCanceledOnTouchOutside(false);
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, pGetSyllabusURL, new Response.Listener<String>() {
            @Override
                ...
                if (sResult != null) {
                    ...
                    try {
                        ...
                        if (!jsonObject.getBoolean("error")) {
                            ...
                            mStudentSyllabusListAdapter = new StudentSyllabusListAdapter(ParentSyllabusLastActivity.this, arraylist);
                            lvSyllabus.setAdapter(mStudentSyllabusListAdapter);


                        } else {
                            Toast.makeText(ParentSyllabusLastActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                        }
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(getApplicationContext(), ParentSyllabusFirstActivity.class);
        startActivity(intent);
        finish();
    }
