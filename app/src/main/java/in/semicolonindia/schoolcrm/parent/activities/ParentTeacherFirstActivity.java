...
public class ParentTeacherFirstActivity extends AppCompatActivity {
    ListView lvStudentName;
    AssignmentFirstAdapter mTeachersListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.parent_activity_teachers_first);
        ...
        lvStudentName.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (new ConnectionDetector(getApplicationContext()).isConnectingToInternet()) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), ParentTeacherLastActivity.class);
    ...
    public void getChildrenList() {
        mProgressDialog = new ProgressDialog(ParentTeacherFirstActivity.this, "Loading Teacher...");
            ...
            public void onResponse(String response) {
                if (response != null) {
                    ...
                    try {
                        ...
                        mTeachersListAdapter = new AssignmentFirstAdapter(getApplicationContext(), arraylist, lvStudentName);
                    ...
                    Toast.makeText(ParentTeacherFirstActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                    mProgressDialog.dismiss();
                }
            }
