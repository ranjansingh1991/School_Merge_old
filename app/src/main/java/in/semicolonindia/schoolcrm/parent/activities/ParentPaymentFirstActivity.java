...
import in.semicolonindia.schoolcrm.parent.adapters.ParentPaymentFirstAdapter;
...
public class ParentPaymentFirstActivity extends AppCompatActivity {
    ListView lvStudentName;
    ParentPaymentFirstAdapter mStudentListAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.parent_activity_payment_first);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ParentPaymentFirstActivity.this, ParentHomeActivity.class);
        ...
        lvStudentName.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(new ConnectionDetector(getApplicationContext()).isConnectingToInternet()){
                    ...
                    Intent intent = new Intent(getApplicationContext(), ParentPaymentLastActivity.class);
                    intent.putExtras(bundle);
                    startActivity(intent);
                    overridePendingTransition(R.anim.slide_in_bottom, R.anim.slide_out_bottom);
                } else {
                    final NoConnectionDialog mNoConnectionDialog = new NoConnectionDialog(ParentPaymentFirstActivity.this,
    ...
    public void getChildrenList() {
        mProgressDialog = new ProgressDialog(ParentPaymentFirstActivity.this, "Loading Transport...");
            ...
            public void onResponse(String response) {
                if (response != null) {
                    ...
                    try {
                        ...
                        mStudentListAdapter = new ParentPaymentFirstAdapter(getApplicationContext(), arraylist);
                    ...
                    Toast.makeText(ParentPaymentFirstActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                    mProgressDialog.dismiss();
                }
            }
