...
public class ParentSubjectFirstActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.parent_activity_subject_first);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ParentSubjectFirstActivity.this, ParentHomeActivity.class);
        ...
        lvStudentName.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if(new ConnectionDetector(getApplicationContext()).isConnectingToInternet()){
                    ...
                    Intent intent = new Intent(getApplicationContext(), ParentSubjectLastActivity.class);
                    ...
                    final NoConnectionDialog mNoConnectionDialog = new NoConnectionDialog(ParentSubjectFirstActivity.this,
    ...
    {
        mProgressDialog = new ProgressDialog(ParentSubjectFirstActivity.this, "Loading Subject...");
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, pLoginURL, new Response.Listener<String>() {
            ...
            public void onResponse(String response)
            {
                ...
                {
                    Toast.makeText(ParentSubjectFirstActivity.this, "Something went wrong", Toast.LENGTH_SHORT).show();
                    mProgressDialog.dismiss();
                }
            }
