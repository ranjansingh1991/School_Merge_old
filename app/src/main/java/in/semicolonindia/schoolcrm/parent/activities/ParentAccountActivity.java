...
import in.semicolonindia.schoolcrm.parent.adapters.ParentAccountListAdapter;
...
import static in.semicolonindia.schoolcrm.rest.BaseUrl.pGetAUploadImageURL;
import static in.semicolonindia.schoolcrm.rest.BaseUrl.pGetProfile;
...
public class ParentAccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(ParentAccountActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(ParentAccountActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
            } else {
                ActivityCompat.requestPermissions(ParentAccountActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, READ_ES);
            }
        }
        if (ContextCompat.checkSelfPermission(ParentAccountActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(ParentAccountActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            } else {
                ActivityCompat.requestPermissions(ParentAccountActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, WRITE_ES);
            }
        }
        if (ContextCompat.checkSelfPermission(ParentAccountActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(ParentAccountActivity.this, Manifest.permission.CAMERA)) {
            } else {
                ActivityCompat.requestPermissions(ParentAccountActivity.this, new String[]{Manifest.permission.CAMERA}, CAMERA);
            }
        }

        setContentView(R.layout.parent_activity_account);
    ...
    private void getData() {
        mProgressDialog = new ProgressDialog(ParentAccountActivity.this, "Uploading...", "Loading profile data...");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        mProgressDialog.setCancelable(false);
        mProgressDialog.setCanceledOnTouchOutside(false);
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, pGetProfile, new Response.Listener<String>() {
            @Override
                    ...
                    try {
                        ...
                        if (!jsonObject.getBoolean("error")) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                rvAccounts.setAdapter(new ParentAccountListAdapter(ParentAccountActivity.this, mAccountBean));
                            }
                        } else {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAMERA && resultCode == RESULT_OK) {
            ...
            if (outPutFile.exists()) {
                ...
                ParentAccountListAdapter.civUserPic.setImageBitmap(photo);
    ...
    private void uploadImageToServer(final String sTempImg) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, pGetAUploadImageURL, new Response.Listener<String>() {
            @Override
            ...
            @Override
            public void onErrorResponse(VolleyError volleyError) {
                Toast.makeText(ParentAccountActivity.this, "Some error occurred -> " + volleyError, Toast.LENGTH_LONG).show();
        ...
        RequestQueue rQueue = Volley.newRequestQueue(ParentAccountActivity.this);
        rQueue.add(request);
    }
...
//    }
    ...
    public void CropingIMG() {
        ...
        if (size == 0) {
            ...
            if (size == 1) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(ParentAccountActivity.this);
    ...
    public void onBackPressed() {
        ...
        Intent intent=new Intent(ParentAccountActivity.this,ParentHomeActivity.class);
