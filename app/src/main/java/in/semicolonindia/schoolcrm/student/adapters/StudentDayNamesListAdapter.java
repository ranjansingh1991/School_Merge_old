...
public class StudentDayNamesListAdapter extends BaseAdapter {
    ...
    public StudentDayNamesListAdapter(Context context, int nHeight) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        convertView = layoutInflater.inflate(R.layout.student_day_names_list_item, null);
