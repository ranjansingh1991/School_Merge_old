...
import in.semicolonindia.schoolcrm.teacher.adapters.TeacherAccountListAdapter;
import in.semicolonindia.schoolcrm.teacher.beans.TeacherAccountBean;
import in.semicolonindia.schoolcrm.util.CropingOption;
import in.semicolonindia.schoolcrm.util.CropingOptionAdapter;
import in.semicolonindia.schoolcrm.util.PreferencesManager;

import static in.semicolonindia.schoolcrm.rest.BaseUrl.sGetAUploadImageURL;
import static in.semicolonindia.schoolcrm.rest.BaseUrl.sGetProfile;
import static in.semicolonindia.schoolcrm.rest.BaseUrl.tGetAUploadImageURL;
import static in.semicolonindia.schoolcrm.rest.BaseUrl.tGetProfile;
...
public class TeacherAccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(TeacherAccountActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(TeacherAccountActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
            } else {
                ActivityCompat.requestPermissions(TeacherAccountActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, READ_ES);
            }
        }
        if (ContextCompat.checkSelfPermission(TeacherAccountActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(TeacherAccountActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            } else {
                ActivityCompat.requestPermissions(TeacherAccountActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, WRITE_ES);
            }
        }
        if (ContextCompat.checkSelfPermission(TeacherAccountActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(TeacherAccountActivity.this, Manifest.permission.CAMERA)) {
            } else {
                ActivityCompat.requestPermissions(TeacherAccountActivity.this, new String[]{Manifest.permission.CAMERA}, CAMERA);
            }
        }
        setContentView(R.layout.teacher_activity_account);
    ...
    private void getData() {
        mProgressDialog = new ProgressDialog(TeacherAccountActivity.this,"uploading profile data");
        mProgressDialog.getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        mProgressDialog.setCancelable(false);
        mProgressDialog.setCanceledOnTouchOutside(false);
        mProgressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, tGetProfile, new Response.Listener<String>() {
            @Override
                    ...
                    try {
                        ...
                        if (!jsonObject.getBoolean("error")) {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                TeacherAccountBean mAccountBean = new TeacherAccountBean();
                                ...
                                rvAccounts.setAdapter(new TeacherAccountListAdapter(TeacherAccountActivity.this, mAccountBean));
                            }
                        } else {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAMERA && resultCode == RESULT_OK) {
            ...
            if (outPutFile.exists()) {
                ...
                TeacherAccountListAdapter.civUserPic.setImageBitmap(photo);
    ...
    private void uploadImageToServer(final String sTempImg) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, tGetAUploadImageURL, new Response.Listener<String>() {
            @Override
            ...
            @Override
            public void onErrorResponse(VolleyError volleyError) {
                Toast.makeText(TeacherAccountActivity.this, "Some error occurred -> " + volleyError, Toast.LENGTH_LONG).show();
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                parameters.put("login_type", "teacher");
        ...
        RequestQueue rQueue = Volley.newRequestQueue(TeacherAccountActivity.this);
        rQueue.add(request);
    }
    ...
    public void CropingIMG() {
        ...
        if (size == 0) {
            ...
            if (size == 1) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(TeacherAccountActivity.this);
