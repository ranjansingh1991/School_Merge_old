...
import in.semicolonindia.schoolcrm.student.adapters.NewsAdapter;
import in.semicolonindia.schoolcrm.student.beans.NewsName;
@SuppressWarnings("ALL")
public class ParentNewsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.parent_activity_news);
        ...
        imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // onBackPressed();
                Intent intent = new Intent(ParentNewsActivity.this, ParentHomeActivity.class);
